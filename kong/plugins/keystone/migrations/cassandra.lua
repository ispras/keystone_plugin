return {
  {
    ...
    up = [[
      ...
      CREATE INDEX IF NOT EXISTS ON endpoint(service_id) WITH read_repair_chance = 0 and dclocal_read_repair_chance = 0;
      CREATE INDEX IF NOT EXISTS ON endpoint(region_id) WITH read_repair_chance = 0 and dclocal_read_repair_chance = 0;
